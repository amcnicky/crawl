...
static const duration_def duration_data[] =
{
    ...
    { DUR_HORRIFYING_VISAGE,
        MAGENTA, "Horrify",
        "horrifying", "horrifying visage",
        "Your face bears the decay and horror of ancient times.", D_DISPELLABLE | D_EXPIRES,
        {{ "Your visage returns to normal." },
        { "Your horrifying visage is starting to fade.", 1 }}, 6},
    ...
    { DUR_OBSIDIAN_GATEWEB_VISION,
      CYAN, "Gateweb",
      "gateweb vision", "seeing through gateweb",
      "You can see through the obsidian gateweb.", D_EXPIRES,
      {{ "Your vision of the gateweb fades.", end_obsidian_gateweb_vision }}},
