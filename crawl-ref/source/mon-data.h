...
{
    MONS_SPRIGGAN_SIDEKICK, 'i', BROWN, "spriggan sidekick",
    M_NO_POLY_TO | M_NO_GEN_DERIVED | M_FAST_REGEN | M_SEE_INVIS | M_SIDEKICK,
...
//ancient god only - no poly, no xp - no incentive to scum
{
    ...
    {TILEP_MONS_PLAGUE_WORM}, TILE_CORPSE_SWAMP_WORM
},
