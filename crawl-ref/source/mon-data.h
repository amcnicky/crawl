...
// arachnids ('s')
{
    MONS_MORLOTH, 's', RED, "Morloth",
    M_NO_SKELETON | M_FEMALE,
    MR_VUL_POISON,
    11, MONS_SPIDER, MONS_WOLF_SPIDER, MH_NATURAL, 40,
    { {AT_HIT, AF_PLAIN, 35}, {AT_BITE, AF_POISON, 25}, AT_NO_ATK,
       AT_NO_ATK },
    16, 1800,
    12, 4, MST_MORLOTH, true, S_HISS,
    I_ANIMAL, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_NOTHING, SIZE_LARGE, MON_SHAPE_ARACHNID,
    {TILEP_MONS_MORLOTH}, TILE_CORPSE_WOLF_SPIDER
},
