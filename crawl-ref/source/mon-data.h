...
// grouping spectral guard with spectral weapon for now
{
    MONS_SPECTRAL_GUARD, 'p', GREEN, "spectral guard",
    M_FIGHTER | M_INSUBSTANTIAL | M_NO_REGEN | M_SEE_INVIS | M_NO_EXP_GAIN
        | M_FLIES,
    MR_NO_FLAGS,
    10, MONS_WRAITH, MONS_SPECTRAL_GUARD, MH_NONLIVING, MAG_IMMUNE,
    {{AT_HIT, AF_PLAIN, 20}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    13, 715,
    1, 13, MST_NO_SPELLS, false, S_SILENT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_NOTHING, SIZE_MEDIUM, MON_SHAPE_HUMANOID,
    {TILEP_MONS_SPECTRAL_GUARD}, TILE_ERROR
},
